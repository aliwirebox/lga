...
function transformBaseMatchForDatatable($candidate)
{
    ...
    return [
        ...
        'has_degree'                       => boolToText($candidate->has_degree),
        ...
        'languages'                        => $candidate->languages->pluck('name'),
        'training_seats'                   => $candidate->trainingSeats->pluck('name'),
        ...
        'has_lpc'                          => boolToText($candidate->has_lpc),
        'member_institute_paralegals'      => boolToText($candidate->member_institute_paralegals),
        'member_of_cilex'                  => boolToText($candidate->member_of_cilex),
...
function transformCandidateMatchForDatatable($candidate)
{
    ...
    $additionalData = [
        ...
        'prefered_departments'    => $candidate->preferedDepartments->pluck('name'),
        'prefered_law_firm_bands' => $candidate->preferedLawFirmBands()->childless()->get()->pluck('name'),
        'prefered_locations'      => $candidate->preferedLocations->pluck('name'),
