...
function transformBaseMatchForDatatable($candidate)
{
    ...
    return [
        ...
        'has_degree'                       => $candidate->has_degree ? 'Yes' : 'No',
        ...
        'member_institute_paralegals'      => $candidate->member_institute_paralegals ? 'Yes' : 'No',
        'member_of_cilex'                  => $candidate->member_of_cilex ? 'Yes' : 'No',
