...
(function($){
	$.cookieBar = function(options,val){
		...
		var cookieEntry = 'cb-enabled={value}; expires='+expireDate+'; path=/; domain='+document.location.hostname+'';
		...
		if(doReturn=='cookies'){
			...
			if(options.forceShow || cookieValue=='enabled' || cookieValue==''){
				if(options.append){
					$(options.element).append('<div class="container-fluid cookie-background"><div class="container"><div class="row">   <div class="col-md-10"><div id="cookie-bar"'+fixed+zindex+'><p>'+message+' <span class="pull-right">'+acceptButton+declineButton+policyButton+'</span> </p></div></div>  </div></div></div>');
				}else{
					$(options.element).prepend(
						'<div class="container-fluid cookie-background">'+
