(function (jQuery) {
     ...
     * @param element
     */
    jQuery.referralCandidateModal = function (element) {
        var self = this;
     ...
     * @returns {*}
     */
    jQuery.fn.referralCandidateModal = function (options) {
        //Loop through all the jQuery elements matched and attach an instance of the plugin
        return this.each(function () {
            (new jQuery.referralCandidateModal(this, options));
        });
    };
})(jQuery);

jQuery(document).ready(function () {
    jQuery('.referral-candidate-link').referralCandidateModal();
});