<div class="top-nav">
    <ul>
        ...
        <li><a href="{{ route('brand-admin.live-candidates') }}" title="Live Candidates"><i class="fa fa-users"></i></a></li>
        <li><a href="{{ route('brand-admin.cv-processing') }}" title="CV Processing"><i class="fa fa-address-card"></i></a></li>
        <li><a href="{{ route('brand-admin.cv-requests') }}" title="CV Requests"><i class="fa fa-address-card-o"></i></a></li>
        ...
        <li><a href="{{ url('logout') }}" title="Sign Out"><i class="fa fa-sign-out"></i></a></li>
    </ul>
</div>