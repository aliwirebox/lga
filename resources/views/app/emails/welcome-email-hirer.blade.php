...
@section('content')
    ...
    <p>Upon logging in as a Hirer you will be taken to your Dashboard, which provides a summary of your ‘Active Candidates’, outstanding ‘CV Requests’ and your ‘Saved Searches & Matches’.</p>
