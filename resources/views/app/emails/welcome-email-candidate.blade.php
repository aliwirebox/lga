...
@section('content')
    ...
    <p>We are on hand if you have any questions. You can email us at {{ config('brand.email.support') }} or call us on <a href=" {{ config('brand.phones.main-formatted') }} ">{{ config('brand.phones.mainspaced') }}</a>.</p> 
