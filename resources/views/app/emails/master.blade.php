                                ...
                                <table width="640" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="left" valign="top" >
                                            <table width="640" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="left" valign="top"><a href="{{ url('/') }} "><img src="{{asset('img/email/logo_banner.jpg')}}" alt="NQ Solicitors - Professional. Discreet. Unique." width="640" height="109" style="display:block"/></a></td>
                                                </tr>
                                                <tr>
