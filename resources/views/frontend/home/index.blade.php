...
@section('content')
        ...
        <div class="container">
			...
			COMPANIES FIND THEIR PERFECT MATCH.
                        ...
                        <p>{{ config('brand.web.domain') }} offers Candidates and Employers the opportunity to take complete control of the recruitment process and the level of market ‘reach’ that cannot be achieved by traditional legal recruitment agencies.</p>
