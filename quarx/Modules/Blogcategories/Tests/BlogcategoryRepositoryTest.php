...
class BlogcategoryRepositoryTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->repo = $this->app->make(BlogcategoryRepository::class);
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Blogcategory\Blogcategory');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('blogcategories', $this->editedArray);
    }
